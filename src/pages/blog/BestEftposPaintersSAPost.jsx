...
const crumbs = [
  ...
  { label: 'Best EFTPOS for Painters in South Australia (2026)' },
]
const faqs = [
  {
    q: 'What is the best EFTPOS for painters in South Australia?',
    a: 'Zeller Terminal 1 with the Optus SIM plan is the top pick for SA painters. At 1.4% in-person with same-day settlement, it covers Adelaide Hills heritage work and outer suburb new builds.'
  },
  {
    q: 'Does Zeller work in Adelaide and regional SA?',
    a: 'Yes — Zeller Terminal 1\'s Optus SIM covers Adelaide metro and most regional SA towns including the Adelaide Hills, Barossa, and Yorke Peninsula.'
  },
  {
    q: 'What card payment fees do painters pay in South Australia?',
  ...
  {
    q: 'Do I need a licence to accept card payments as a painter in SA?',
...
const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: 'Best EFTPOS for Painters in South Australia (2026)',
    ...
    image: {
      '@type': 'ImageObject',
      url: blogOgUrl('best-eftpos-painters-sa-2026'),
      width: 1200,
      height: 630
    }
  },
  {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Best EFTPOS for Painters in South Australia (2026)',
        item: 'https://tradiepayau.directory/blog/best-eftpos-painters-sa-2026'
      }
    ]
  },
  {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'TradiePay AU — EFTPOS Guides for South Australia Painters',
    description: 'Best EFTPOS terminal for painters in South Australia.',
    url: 'https://tradiepayau.directory/blog/best-eftpos-painters-sa-2026',
    areaServed: [
      {
        '@type': 'City',
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What is the best EFTPOS for painters in South Australia?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Zeller Terminal 1 with the Optus SIM plan is the top pick for SA painters. At 1.4% in-person with same-day settlement, it covers Adelaide Hills heritage work and outer suburb new builds.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes — Zeller Terminal 1\'s Optus SIM covers Adelaide metro and most regional SA towns including the Adelaide Hills, Barossa, and Yorke Peninsula.'
        }
      },
      {
        '@type': 'Question',
        name: 'What card payment fees do painters pay in South Australia?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Do I need a licence to accept card payments as a painter in SA?',
        acceptedAnswer: {
          '@type': 'Answer',
...
export default function BestEftposPaintersSAPost() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Painters in South Australia (2026)"
        description="Best EFTPOS for SA painters — Adelaide Hills heritage work, outer suburb new builds, and deposit collection before starting multi-day jobs."
        canonical="/blog/best-eftpos-painters-sa-2026"
        ogType="article"
        geoRegion="AU-SA"
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={blogHeroUrl('best-eftpos-painters-sa-2026')} alt="" fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />
      ...
      <section id="verdict" className="section container-page">
        ...
        <div className="infobox mb-6">
          <p className="text-sm text-slate-700 leading-relaxed">
            <strong>Zeller Terminal 1</strong> is the top pick for South Australia painters. Zeller Terminal 1 is the top pick for SA painters. At 1.4% in-person with SIM connectivity and same-day settlement, it covers Adelaide Hills heritage work, outer suburb new builds, and remote SA regional jobs.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-wrap gap-4 text-sm">
          <Link to="/trades/painters/sa" className="text-brand-blue font-medium hover:underline">
            South Australia Painters guide on TradiePay →
          </Link>
      ...
      <section id="coverage" className="section section-alt">
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: 'Adelaide Hills heritage painting', body: 'Heritage painting in the Adelaide Hills — Stirling, Hahndorf, and Aldgate — involves premium jobs in areas with limited NBN. SIM connectivity handles payment at job completion.' },
              ...
              { title: 'Deposit collection before starting', body: 'SA painters collecting deposits before multi-day jobs use Zeller payment links (1.7%) — clients pay via SMS before work begins, covering material costs upfront.' },
          ...
          <div className="mt-6 lg-light rounded-2xl p-5">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">Painters in South Australia are regulated by <strong>Consumer and Business Services (CBS)</strong>. SA painters require a painting work licence from Consumer and Business Services (CBS). An ABN is needed to open a merchant account.</p>
          </div>
        </div>
      </section>
      <FaqSection items={faqs} title={`FAQ — Painters in South Australia`} />

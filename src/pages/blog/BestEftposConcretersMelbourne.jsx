...
const faqs = [
  ...
  },
  {
    ...
    a: 'Zeller settles same-day to a Zeller Transaction Account. For Melbourne concreters who purchase materials after a job, same-day funds mean no waiting overnight. Square and Stripe both settle next business day by default.',
  },
]
const jsonLd = [
  {

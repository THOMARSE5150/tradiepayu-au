...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Tilers in South Australia (2026)', description: 'Best EFTPOS for SA tilers — Adelaide bathroom renovations, Hills luxury home tiling, and new estate tiling across greater Adelaide.', url: `${SITE}/blog/best-eftpos-tilers-sa-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/${IMG}?w=1200&h=630&fit=crop&crop=right&q=80`, width: 1200, height: 630 } },

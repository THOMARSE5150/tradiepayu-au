...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Fencers in Sydney (2026)', description: 'Best EFTPOS for Sydney fencers — new estate colourbond fencing, pool fencing in inner suburbs, and acreage fencing on the urban fringe.', url: `${SITE}/blog/best-eftpos-fencers-sydney-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=1200&h=630&fit=crop&crop=center&q=80`, width: 1200, height: 630 } },

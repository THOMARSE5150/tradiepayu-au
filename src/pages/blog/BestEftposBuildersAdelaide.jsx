...
const faqs = [
  ...
  },
  {
    ...
    a: 'Zeller settles same-day to a Zeller Transaction Account. For Adelaide builders who purchase materials after a job, same-day funds mean no waiting overnight. Square settles next business day; Stripe settles in 2 business days by default.',
  },
]
const jsonLd = [
  {
    ...
    image: { '@type': 'ImageObject', url: blogOgUrl('best-eftpos-builders-adelaide-2026'), width: 1200, height: 630 },
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={blogHeroUrl('best-eftpos-builders-adelaide-2026')} alt="" fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />

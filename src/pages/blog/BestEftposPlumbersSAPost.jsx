...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: "Best EFTPOS for Plumbers in South Australia (2026)", description: "Best EFTPOS for SA plumbers — Adelaide metro emergency call-outs, same-day settlement, and regional SA connectivity.", datePublished: '2026-04-02', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/blog/best-eftpos-plumbers-sa-2026` },

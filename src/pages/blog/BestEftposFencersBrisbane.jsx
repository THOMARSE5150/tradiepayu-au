...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Fencers in Brisbane (2026)', description: 'Best EFTPOS for Brisbane fencers — SEQ new estate colourbond fencing, rural acreage in outer Brisbane, and cyclone-rated fencing in bayside suburbs.', url: `${SITE}/blog/best-eftpos-fencers-brisbane-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=1200&h=630&fit=crop&crop=entropy&q=80`, width: 1200, height: 630 } },

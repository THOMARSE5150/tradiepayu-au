...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: "Best EFTPOS for Painters in Queensland (2026)", description: "Best EFTPOS for Queensland painters — deposit collection, SEQ new build sites, and body corporate billing for Brisbane and Sunshine Coast.", datePublished: '2026-04-02', dateModified: '2026-04-02', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/blog/best-eftpos-painters-qld-2026` },

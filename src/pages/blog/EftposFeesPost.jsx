    ...
    <>
      ...
      <section className="section container-page">
        ...
        >
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            At Zeller's 1.4% rate, a $500 job costs you $7.00 in processing fees. At Square's 1.6%, it's $8.00. At Stripe's 1.7% plus $0.10, it's $8.60. Small differences per job — but they compound across a month of work.
          </p>
          <p className="text-slate-600 leading-relaxed">
            None of Zeller, Square, or Stripe charge a monthly fee on standard accounts. You pay only when you take a payment. This is the flat-rate model, and it's what most tradies should use unless their volume is high enough to justify a negotiated rate through a bank merchant account or Tyro.
          </p>
        </motion.div>
      </section>

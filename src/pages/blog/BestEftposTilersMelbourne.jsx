...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Tilers in Melbourne (2026)', description: 'Best EFTPOS for Melbourne tilers — bathroom renovations in inner suburbs, new estate tiling in growth corridors, and heritage apartment restoration.', url: `${SITE}/blog/best-eftpos-tilers-melbourne-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/${IMG}?w=1200&h=630&fit=crop&crop=faces&q=80`, width: 1200, height: 630 } },

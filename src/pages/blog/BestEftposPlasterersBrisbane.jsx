...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Plasterers in Brisbane (2026)', description: 'Best EFTPOS for Brisbane plasterers — Queenslander wall and ceiling restoration, SEQ new estate set plaster, and coastal renovation plasterwork.', url: `${SITE}/blog/best-eftpos-plasterers-brisbane-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/${IMG}?w=1200&h=630&fit=crop&crop=entropy&q=80`, width: 1200, height: 630 } },

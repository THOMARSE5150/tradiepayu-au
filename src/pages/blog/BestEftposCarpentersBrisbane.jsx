...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Carpenters in Brisbane (2026)', description: 'Best EFTPOS for Brisbane carpenters — Queenslander timber restoration, SEQ new estate framing, and same-day settlement.', url: `${SITE}/blog/best-eftpos-carpenters-brisbane-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1200&h=630&fit=crop&crop=entropy&q=80`, width: 1200, height: 630 } },

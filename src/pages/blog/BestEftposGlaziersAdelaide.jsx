...
const faqs = [
  ...
  { q: 'Do Adelaide glaziers need WiFi to take card payments?', a: 'No — Zeller Terminal 1 has built-in Optus SIM connectivity. Adelaide glaziers on emergency callouts can take payment on the spot without using customer WiFi.' },
  { q: 'What are the card payment fees for glaziers in Adelaide?', a: 'Zeller charges 1.4% for in-person tap/chip/swipe — the lowest flat rate in Australia. No monthly fee. The SIM plan adds $15/month on top of the $99 terminal.' },
  { q: 'How quickly do card payments settle for Adelaide glaziers?', a: 'Zeller settles same-day to a Zeller Transaction Account — Adelaide glaziers can order replacement glass the same afternoon a payment is collected.' },
...
export default function BestEftposGlaziersAdelaide() {
  return (
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">Best EFTPOS for Glaziers in Adelaide (2026)</h1>
          <p className="hero-sub">Covering emergency glass replacement across Adelaide, Adelaide Hills luxury home glazing, and new estate window installation in Angle Vale and Mount Barker.</p>
      ...
      <section id="verdict" className="section container-page">
        <motion.h2 initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="text-2xl font-bold text-brand-dark mb-4">Best EFTPOS for Glaziers in Adelaide</motion.h2>
        <div className="infobox mb-6"><p className="text-sm text-slate-700 leading-relaxed"><strong>Zeller Terminal 1</strong> is the top pick for Adelaide glaziers. At 1.4% in-person with SIM connectivity and same-day settlement, it handles emergency callouts, Hills luxury glazing, and new estate window installation without relying on customer WiFi.</p></div>
        ...
        <div className="mt-4 flex flex-wrap gap-4 text-sm">
          ...
          <Link to="/blog/best-eftpos-glaziers-sa-2026" className="text-brand-blue font-medium hover:underline">SA state EFTPOS guide →</Link>
      ...
      <section id="context" className="section section-alt">
        <div className="container-page">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Adelaide glazing — what shapes your payment needs</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: 'Emergency glass replacement', body: 'Emergency glass replacement across Adelaide involves same-day callouts with no access to customer WiFi. SIM connectivity handles payment on the spot at job completion.' },
              { title: 'Adelaide Hills luxury home glazing', body: 'Luxury frameless glass and double glazing in Stirling, Aldgate, and Crafers involves high-value jobs at homes without shared WiFi. SIM connectivity ensures payment collection every time.' },
              ...
              { title: 'Same-day settlement', body: 'Zeller settles to your Zeller Transaction Account same day — replacement glass can be ordered the same afternoon a payment is collected on an Adelaide job.' },
            ].map((c, i) => (
      ...
      <FaqSection items={faqs} title="FAQ — Glaziers in Adelaide" />

...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Cleaners in Perth (2026)', description: 'Best EFTPOS for Perth cleaners — residential cleans, end-of-lease cleans at vacant properties, and post-construction cleaning in Ellenbrook, Baldivis, and Harrisdale.', url: `${SITE}/blog/best-eftpos-cleaners-perth-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/${IMG}?w=1200&h=630&fit=crop&crop=top&q=80`, width: 1200, height: 630 } },

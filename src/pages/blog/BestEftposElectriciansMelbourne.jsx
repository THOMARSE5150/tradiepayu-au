...
const crumbs = [
  ...
  { label: "Best EFTPOS for Electricians in Melbourne (2026)" },
]
...
const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: "Best EFTPOS for Electricians in Melbourne (2026)",
    description: "Best EFTPOS for Melbourne electricians — CBD high-rise fit-outs, growth corridor estates, and regional Victoria. SIM connectivity at 1.4%.",
    datePublished: '2026-04-02',
    dateModified: siteMeta.lastVerified,
    author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE },
    publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE },
    url: `${SITE}/blog/best-eftpos-electricians-melbourne-2026`,
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "Best EFTPOS for Electricians in Melbourne (2026)", item: `${SITE}/blog/best-eftpos-electricians-melbourne-2026` },
    ],
  },
  {
    '@context': 'https://schema.org',
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: "TradiePay AU — Best EFTPOS for Electricians in Melbourne (2026)",
    description: "Best EFTPOS for Melbourne electricians — CBD high-rise fit-outs, growth corridor estates, and regional Victoria. SIM connectivity at 1.4%.",
    url: `${SITE}/blog/best-eftpos-electricians-melbourne-2026`,
    areaServed: { '@type': 'City', name: "Melbourne" },
    knowsAbout: ['EFTPOS terminals', "Electricians", 'card payments', "Melbourne"],
  },
]

export default function BestEftposElectriciansMelbourne() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Electricians in Melbourne (2026)"
        description="Best EFTPOS for Melbourne electricians — CBD high-rise fit-outs, growth corridor estates, and regional Victoria. SIM connectivity at 1.4%."
        canonical="/blog/best-eftpos-electricians-melbourne-2026"
        ogType="article"
        jsonLd={jsonLd}
      />
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={blogHeroUrl('best-eftpos-electricians-melbourne-2026')}
            alt=""
            fetchPriority="high"
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">
            Best EFTPOS for Electricians in Melbourne (2026)
          </h1>
          <p className="hero-sub">
            Melbourne CBD switchboard fit-outs, outer suburb estates in Werribee and Cranbourne, and after-hours residential emergencies — SIM connectivity is non-negotiable.
          </p>
        </div>
      </header>
      ...
      <article className="container-page section max-w-3xl">
        ...
        <section className="mb-10 space-y-5">
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-6">Provider comparison for Melbourne electricians</h2>
          <ComparisonTable headers={comparisonHeaders} rows={comparisonRows} />

          <h2 className="text-xl font-bold text-brand-dark mt-6">#1 Zeller Terminal 1 + SIM — best for most Melbourne electricians</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/zeller" className="text-brand-blue hover:underline">Zeller Terminal 1</Link> with the $15/month Optus SIM plan handles the full range of Melbourne electricians work. The terminal uses Optus 4G independently — no customer WiFi, no phone hotspot. At 1.4% in-person rate and same-day settlement, it is the lowest-cost, fastest-settlement option.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed mt-2">
            Optus 4G covers Melbourne metro comprehensively — CBD, Inner North, Inner South, Bayside, Western Suburbs, and all outer growth corridors. Hardware is $99 outright.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">#2 Square Terminal — backup for dead zones</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/square" className="text-brand-blue hover:underline">Square Terminal</Link> ($329) with offline mode handles basement substations, underground plant rooms, and any Melbourne site where even mobile data is absent. Alpine Victoria and very remote rural areas have limited Optus coverage. For those sites, Square Terminal offline mode stores the transaction and processes within 24 hours.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">Cost at typical Melbourne electricians volumes</h2>
        ...
        <section className="mb-10">
          <div id="recommendation" className="lg-blue rounded-2xl p-6">
            <h3 className="font-bold text-brand-dark mb-3">Our recommendation for Melbourne electricians</h3>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link to="/trades/electricians/vic" className="text-sm font-semibold text-brand-blue hover:underline">VIC Electricians guide →</Link>

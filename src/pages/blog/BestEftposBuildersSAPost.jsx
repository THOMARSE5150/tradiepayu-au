...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: "Best EFTPOS for Builders in South Australia (2026)", description: "Best EFTPOS for SA builders — Adelaide growth corridor estates, payment links for progress invoices, and same-day settlement for material purchasing.", datePublished: '2026-04-02', dateModified: '2026-04-02', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/blog/best-eftpos-builders-sa-2026` },

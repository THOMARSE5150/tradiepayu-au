...
const faqs = [
  ...
  },
  {
    ...
    a: 'Zeller settles same-day to a Zeller Transaction Account. For Adelaide plumbers who purchase materials after a job, same-day funds mean no waiting overnight. Square settles next business day; Stripe settles in 2 business days by default.',
  },
]
const jsonLd = [
  {
    ...
    image: { '@type': 'ImageObject', url: `https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?w=1200&h=630&fit=crop&crop=center&q=80`, width: 1200, height: 630 },
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',

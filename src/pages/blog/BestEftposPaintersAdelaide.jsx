...
const jsonLd = [
  {
    ...
    image: {
      '@type': 'ImageObject',
      url: blogOgUrl('best-eftpos-painters-adelaide-2026'),
      width: 1200,
      height: 630
    }
  },
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={blogHeroUrl('best-eftpos-painters-adelaide-2026')} alt="" fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />

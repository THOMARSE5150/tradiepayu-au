...
const crumbs = [
  ...
  { label: "Best EFTPOS for Electricians in Sydney (2026)" },
]
...
const faqs = [
  {
    q: "What is the best EFTPOS for electricians in Sydney CBD?",
    a: "Zeller Terminal 1 with the Optus SIM plan is the best choice for Sydney CBD electrical work. Switchboard rooms in high-rise buildings, basement plant areas, and server rooms all have poor building WiFi. The SIM terminal processes on Optus 4G independently. At 1.4% in-person rate and same-day settlement, it is also the most cost-effective option.",
  },
  {
...
const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: "Best EFTPOS for Electricians in Sydney (2026)",
    description: "Best EFTPOS for Sydney electricians — CBD switchboard rooms, Western Sydney estates without NBN, and North Shore commercial work. SIM connectivity at 1.4%.",
    datePublished: '2026-04-02',
    dateModified: siteMeta.lastVerified,
    author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE },
    publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE },
    url: `${SITE}/blog/best-eftpos-electricians-sydney-2026`,
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "Best EFTPOS for Electricians in Sydney (2026)", item: `${SITE}/blog/best-eftpos-electricians-sydney-2026` },
    ],
  },
  {
    '@context': 'https://schema.org',
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: "TradiePay AU — Best EFTPOS for Electricians in Sydney (2026)",
    description: "Best EFTPOS for Sydney electricians — CBD switchboard rooms, Western Sydney estates without NBN, and North Shore commercial work. SIM connectivity at 1.4%.",
    url: `${SITE}/blog/best-eftpos-electricians-sydney-2026`,
    areaServed: { '@type': 'City', name: "Sydney" },
    knowsAbout: ['EFTPOS terminals', "Electricians", 'card payments', "Sydney"],
  },
]

export default function BestEftposElectricianssydney() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Electricians in Sydney (2026)"
        description="Best EFTPOS for Sydney electricians — CBD switchboard rooms, Western Sydney estates without NBN, and North Shore commercial work. SIM connectivity at 1.4%."
        canonical="/blog/best-eftpos-electricians-sydney-2026"
        ogType="article"
        jsonLd={jsonLd}
      />
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={blogHeroUrl('best-eftpos-electricians-sydney-2026')}
            alt=""
            fetchPriority="high"
      ...
      <article className="container-page section max-w-3xl">
        ...
        <section className="mb-10 space-y-5">
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-6">Provider comparison for Sydney electricians</h2>
          <ComparisonTable headers={comparisonHeaders} rows={comparisonRows} />

          <h2 className="text-xl font-bold text-brand-dark mt-6">#1 Zeller Terminal 1 + SIM — best for most Sydney electricians</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/zeller" className="text-brand-blue hover:underline">Zeller Terminal 1</Link> with the $15/month Optus SIM plan handles the full range of Sydney electricians work. The terminal uses Optus 4G independently — no customer WiFi, no phone hotspot. At 1.4% in-person rate and same-day settlement, it is the lowest-cost, fastest-settlement option.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed mt-2">
            Hardware is $99 outright, no contract. Optus 4G covers Sydney metro comprehensively — CBD, Inner West, North Shore, Western Sydney, South-West corridor, and Parramatta.
          </p>
        ...
        <section className="mb-10">
          <div id="recommendation" className="lg-blue rounded-2xl p-6">
            <h3 className="font-bold text-brand-dark mb-3">Our recommendation for Sydney electricians</h3>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link to="/trades/electricians/nsw" className="text-sm font-semibold text-brand-blue hover:underline">NSW Electricians guide →</Link>

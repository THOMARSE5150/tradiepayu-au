...
const crumbs = [
  ...
  { label: "Best EFTPOS for Plumbers in NSW (2026)" },
]
...
const faqs = [
  ...
  },
  {
    ...
    a: "Plumbers often need to purchase replacement parts — hot water systems, pipe fittings, fixtures — on the same day as the job. Same-day settlement with Zeller means card revenue collected that day is available in the Zeller Transaction Account before close of business, without waiting until the next morning. Square settles the next business day; Stripe settles in 2 business days.",
  },
  {
    q: "What EFTPOS for NSW emergency plumbing call-outs?",
    a: "Zeller Terminal 1 + SIM plan. Burst pipes, blocked sewers, and hot water system failures happen at any hour — including evenings and weekends when asking for WiFi access is impractical. The SIM terminal processes on its own mobile data. For outback NSW properties beyond Optus coverage, Square Terminal offline mode is the backup.",
  },
]
...
const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: "Best EFTPOS for Plumbers in NSW (2026)",
    ...
    url: `${SITE}/blog/best-eftpos-plumbers-nsw-2026`,
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "Best EFTPOS for Plumbers in NSW (2026)", item: `${SITE}/blog/best-eftpos-plumbers-nsw-2026` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function BestEftposPlumbersNSWPost() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Plumbers in NSW (2026)"
        description="Best EFTPOS for NSW plumbers — same-day settlement for material runs, SIM connectivity for emergency call-outs across Western Sydney and regional NSW."
        canonical="/blog/best-eftpos-plumbers-nsw-2026"
        ogType="article"
        jsonLd={jsonLd}
      />
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={blogHeroUrl('best-eftpos-plumbers-nsw-2026')}
            alt=""
            fetchPriority="high"
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">
            Best EFTPOS for Plumbers in NSW (2026)
          </h1>
          <p className="hero-sub">
            Western Sydney new estates, inner-Sydney terrace renovations, high-rise plant rooms, and regional NSW emergency call-outs — your EFTPOS must work without site WiFi.
          </p>
        </div>
      </header>
      ...
      <article className="container-page section max-w-3xl">
        ...
        <section className="mb-10 space-y-5">
          <h2 className="text-xl font-bold text-brand-dark">Where New South Wales Plumbers lose connectivity</h2>
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-6">Provider comparison for New South Wales Plumbers</h2>
          <ComparisonTable headers={comparisonHeaders} rows={comparisonRows} />

          <h2 className="text-xl font-bold text-brand-dark mt-6">#1 Zeller Terminal 1 + SIM — best for most New South Wales Plumbers</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/zeller" className="text-brand-blue hover:underline">Zeller Terminal 1</Link> with the $15/month Optus SIM plan is the setup that handles the full range of NSW plumbers work. The terminal uses mobile data independently — no site WiFi, no phone hotspot. At 1.4% in-person rate and same-day settlement, it is also the cheapest and fastest option.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed mt-2">
            Same-day settlement is particularly valuable for plumbers who need to purchase replacement parts from Reece or Tradelink on the same day as the job. Funds are available in the Zeller account before end of business.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">#2 Square Terminal — backup for confirmed dead zones</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/square" className="text-brand-blue hover:underline">Square Terminal</Link> ($329) with offline mode handles rural and remote NSW sites where even mobile signal is absent. For rural NSW properties and outback sites with no mobile signal, Square Terminal offline mode stores the payment locally and processes within 24 hours.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">Cost at typical NSW plumbers volumes</h2>
        ...
        <section className="mb-10">
          <div id="recommendation" className="lg-blue rounded-2xl p-6">
            <h3 className="font-bold text-brand-dark mb-3">Our recommendation for New South Wales Plumbers</h3>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link to="/trades/plumbers/nsw" className="text-sm font-semibold text-brand-blue hover:underline">New South Wales Plumbers guide →</Link>

...
const crumbs = [
  ...
  { label: "Best EFTPOS for Builders in NSW (2026)" },
]
...
const faqs = [
  {
    q: "What is the best EFTPOS for builders in Western Sydney?",
    a: "Zeller Terminal 1 is the best option for Western Sydney builders. The SIM plan handles new estate sites without NBN. Payment links (1.7%) allow deposit collection before work begins. Same-day settlement means material purchase funds are available the same evening. At $99 hardware with no contracts, it is also the lowest-cost setup for builders in NSW.",
  },
  {
    q: "How should NSW builders collect progress payments?",
    a: "Payment links via SMS or email (Zeller: 1.7%, Tyro: 1.4% incl. GST) are the most practical method for NSW progress payments — the client can pay from their banking app without needing to visit the site or hand over a card. For final payments collected in person on site, the Zeller terminal at 1.4% is the lowest-cost method.",
  },
  {
    q: "Can NSW builders run multiple EFTPOS terminals on one site?",
    a: "Yes. Zeller supports multiple terminals under one account — each terminal is purchased outright for $99 with no per-terminal monthly fee. All payments settle centrally into the Zeller Transaction Account. For larger NSW building companies with multiple sites, this is significantly cheaper than bank-provided EFTPOS rental models.",
  },
]
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "Best EFTPOS for Builders in NSW (2026)", item: `${SITE}/blog/best-eftpos-builders-nsw-2026` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function BestEftposBuildersNSWPost() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Builders in NSW (2026)"
        description="Best EFTPOS for NSW builders — payment links for deposits, same-day settlement for material runs, and SIM connectivity across Western Sydney estates."
        canonical="/blog/best-eftpos-builders-nsw-2026"
        ogType="article"
        jsonLd={jsonLd}
      />
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={blogHeroUrl('best-eftpos-builders-nsw-2026')}
            alt=""
            fetchPriority="high"
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">
            Best EFTPOS for Builders in NSW (2026)
          </h1>
          <p className="hero-sub">
            Western Sydney housing estates, Northern Beaches knockdown-rebuilds, and regional NSW commercial builds — from deposit to final payment, your EFTPOS needs to handle large invoices and no-WiFi sites.
          </p>
        </div>
      </header>
      ...
      <article className="container-page section max-w-3xl">
        ...
        <section className="mb-10 space-y-5">
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-6">Provider comparison for New South Wales Builders</h2>
          <ComparisonTable headers={comparisonHeaders} rows={comparisonRows} />

          <h2 className="text-xl font-bold text-brand-dark mt-6">#1 Zeller Terminal 1 + SIM — best for most New South Wales Builders</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/zeller" className="text-brand-blue hover:underline">Zeller Terminal 1</Link> with the $15/month Optus SIM plan is the setup that handles the full range of NSW builders work. The terminal uses mobile data independently — no site WiFi, no phone hotspot. At 1.4% in-person rate and same-day settlement, it is also the cheapest and fastest option.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed mt-2">
            Payment links via SMS or email (1.7%) are the most practical way to collect NSW progress payments — the client pays from their banking app without needing to be on site. Same-day settlement means materials can be purchased the same day funds arrive.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">#2 Square Terminal — backup for confirmed dead zones</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/square" className="text-brand-blue hover:underline">Square Terminal</Link> ($329) with offline mode handles rural and remote NSW sites where even mobile signal is absent. For very remote NSW construction sites (outback, agricultural) with no Optus coverage, Square Terminal offline mode is the backup. Most NSW construction sites are within Optus 4G range.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-6">Cost at typical NSW builders volumes</h2>
        ...
        <section className="mb-10">
          <div id="recommendation" className="lg-blue rounded-2xl p-6">
            <h3 className="font-bold text-brand-dark mb-3">Our recommendation for New South Wales Builders</h3>
            <p className="text-sm text-slate-700 leading-relaxed mb-3">
              <strong>Primary:</strong> Zeller Terminal 1 + Optus SIM plan ($15/mo). Works across New South Wales metro and regional areas. Lowest rate, same-day settlement.
            </p>
            <p className="text-sm text-slate-700 leading-relaxed mb-3">
              <strong>Backup:</strong> Square Terminal. For remote NSW sites with no mobile coverage.
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              <Link to="/trades/builders/nsw" className="text-sm font-semibold text-brand-blue hover:underline">New South Wales Builders guide →</Link>

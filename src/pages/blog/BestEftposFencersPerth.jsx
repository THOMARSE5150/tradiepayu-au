...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Fencers in Perth (2026)', description: 'Best EFTPOS for Perth fencers — new estate colourbond fencing, rural lifestyle fencing in the Hills, and pool fencing installs.', url: `${SITE}/blog/best-eftpos-fencers-perth-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=1200&h=630&fit=crop&crop=bottom&q=80`, width: 1200, height: 630 } },

...
const faqs = [
  ...
  { q: 'Do Sydney tilers need WiFi to take card payments?', a: 'No — Zeller Terminal 1 has built-in Optus SIM connectivity. Tilers working inside renovated bathrooms and kitchens across Sydney can take payment without using the homeowner\'s network.' },
  { q: 'What are the card payment fees for tilers in Sydney?', a: 'Zeller charges 1.4% for in-person tap/chip/swipe — the lowest flat rate in Australia. No monthly fee. The SIM plan adds $15/month on top of the $99 terminal.' },
  { q: 'How quickly do card payments settle for Sydney tilers?', a: 'Zeller settles same-day to a Zeller Transaction Account — Sydney tilers can order tiles and adhesive the same afternoon a deposit is collected.' },
...
export default function BestEftposTilersSydney() {
  return (
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">Best EFTPOS for Tilers in Sydney (2026)</h1>
          <p className="hero-sub">Covering Inner West and Eastern Suburbs bathroom renovations, new estate tiling in Box Hill and Marsden Park, and CBD commercial fit-out — no site WiFi required.</p>
      ...
      <section id="verdict" className="section container-page">
        <motion.h2 initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="text-2xl font-bold text-brand-dark mb-4">Best EFTPOS for Tilers in Sydney</motion.h2>
        <div className="infobox mb-6"><p className="text-sm text-slate-700 leading-relaxed"><strong>Zeller Terminal 1</strong> is the top pick for Sydney tilers. At 1.4% in-person with SIM connectivity via Optus and same-day settlement, it handles bathroom renovations, new estate tiling, and commercial fit-out without relying on customer WiFi.</p></div>
        ...
        <div className="mt-4 flex flex-wrap gap-4 text-sm">
          ...
          <Link to="/blog/best-eftpos-tilers-nsw-2026" className="text-brand-blue font-medium hover:underline">NSW state EFTPOS guide →</Link>
      ...
      <section id="context" className="section section-alt">
        <div className="container-page">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Sydney tiling — what shapes your payment needs</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: 'Inner West and Eastern Suburbs renovations', body: 'Bathroom and kitchen tiling in Newtown, Leichhardt, Bondi, and Randwick involves premium materials in occupied homes without shared WiFi. SIM connectivity handles payment at job completion.' },
              { title: 'Growth corridor new estate tiling', body: 'New estate bathroom tiling in Box Hill, Marsden Park, and Jordan Springs operates on sites without utilities. SIM connectivity handles practical completion payments without customer WiFi.' },
              { title: 'CBD and Parramatta commercial fit-out', body: 'Commercial tiling in Sydney CBD and Parramatta involves restricted site access and no resident WiFi during construction. SIM connectivity is essential for progress claim collection.' },
              { title: 'Same-day settlement', body: 'Zeller settles to your Zeller Transaction Account same day — tiles, adhesive, and grout can be ordered the same afternoon a deposit is collected on a Sydney job.' },
            ].map((c, i) => (
      ...
      <FaqSection items={faqs} title="FAQ — Tilers in Sydney" />

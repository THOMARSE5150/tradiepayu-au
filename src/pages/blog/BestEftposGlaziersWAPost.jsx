...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Glaziers in Western Australia (2026)', description: 'Best EFTPOS for WA glaziers — Perth emergency glass replacement, new estate window installation, and luxury coastal home glazing.', url: `${SITE}/blog/best-eftpos-glaziers-wa-2026`, datePublished: '2026-04-06', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, image: { '@type': 'ImageObject', url: `https://images.unsplash.com/${IMG}?w=1200&h=630&fit=crop&crop=left&q=80`, width: 1200, height: 630 } },

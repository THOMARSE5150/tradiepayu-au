...
const crumbs = [
  ...
  { label: "Best EFTPOS for Electricians in Queensland (2026)" },
]
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Optus 4G covers Cairns, Townsville, Mackay, and Rockhampton. More remote parts of NQ — the Atherton Tablelands hinterland, Gulf Country, and Cape York — have limited coverage. For those locations, Square Terminal offline mode is the backup.",
  },
  {
    q: "What EFTPOS for Queensland electricians during storm season?",
    a: "Zeller Terminal 1 + SIM plan. Storm season emergency work — fuse box replacements, storm damage repairs, generator connections — happens at short notice in any building. SIM connectivity means payment collection is never delayed by WiFi unavailability. Same-day settlement ensures you have access to funds the same day the work is done.",
  },
]
...
const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: "Best EFTPOS for Electricians in Queensland (2026)",
    ...
    url: `${SITE}/blog/best-eftpos-electricians-qld-2026`,
  },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "Best EFTPOS for Electricians in Queensland (2026)", item: `${SITE}/blog/best-eftpos-electricians-qld-2026` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function BestEftposElectriciansQLDPost() {
  return (
    <>
      <Meta
        title="Best EFTPOS for Electricians in Queensland (2026)"
        description="Best EFTPOS for Queensland electricians — SEQ estates, Cairns tropical work, and outback QLD. SIM connectivity and lowest rate for 2026."
        canonical="/blog/best-eftpos-electricians-qld-2026"
        ogType="article"
        jsonLd={jsonLd}
      />
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={blogHeroUrl('best-eftpos-electricians-qld-2026')}
            alt=""
            fetchPriority="high"
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight mt-3">
            Best EFTPOS for Electricians in Queensland (2026)
          </h1>
          <p className="hero-sub">
            South-East Queensland housing estates, Cairns and Townsville commercial work, and outback Queensland — your EFTPOS needs to work wherever Optus reaches.
          </p>
        </div>
      </header>
      ...
      <article className="container-page section max-w-3xl">
        ...
        <section className="mb-10 space-y-5">
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-6">Provider comparison for Queensland Electricians</h2>
          <ComparisonTable headers={comparisonHeaders} rows={comparisonRows} />

          <h2 className="text-xl font-bold text-brand-dark mt-6">#1 Zeller Terminal 1 + SIM — best for most Queensland Electricians</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            <Link to="/providers/zeller" className="text-brand-blue hover:underline">Zeller Terminal 1</Link> with the $15/month Optus SIM plan is the setup that handles the full range of QLD electricians work. The terminal uses mobile data independently — no site WiFi, no phone hotspot. At 1.4% in-person rate and same-day settlement, it is also the cheapest and fastest option.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed mt-2">
            Optus 4G covers SEQ, Cairns, Townsville, and most major QLD regional centres. Hardware is $99 outright. No monthly contract beyond the $15 SIM plan.
          </p>
        ...
        <section className="mb-10">
          <div id="recommendation" className="lg-blue rounded-2xl p-6">
            <h3 className="font-bold text-brand-dark mb-3">Our recommendation for Queensland Electricians</h3>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link to="/trades/electricians/qld" className="text-sm font-semibold text-brand-blue hover:underline">Queensland Electricians guide →</Link>

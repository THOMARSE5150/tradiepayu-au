...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Pest Controllers in Australia (2026)', name: 'Best EFTPOS for Pest Controllers in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('pest-controllers'), width: 1200, height: 630 }, description: 'High-frequency jobs, conveyancer billing, recurring treatment plans, and body corporate invoicing — the best EFTPOS and payment setup for Australian pest controllers.', url: `${SITE}/trades/pest-controllers`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across high-volume pest jobs, inspection reports, and recurring treatment billing.
          </p>

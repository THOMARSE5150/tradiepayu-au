...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Pest Controllers in Australia (2026)', name: 'Best EFTPOS for Pest Controllers in Australia (2026)', image: { '@type': 'ImageObject', url: 'https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?w=1200&h=630&fit=crop&crop=center&q=80', width: 1200, height: 630 }, description: 'High-frequency jobs, conveyancer billing, recurring treatment plans, and body corporate invoicing — the best EFTPOS and payment setup for Australian pest controllers.', url: `${SITE}/trades/pest-controllers`, datePublished: '2026-01-15', dateModified: '2026-03-31', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

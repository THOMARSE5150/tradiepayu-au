  ...
  return (
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across landscape jobs, booking deposits, and variable-size invoices.
          </p>
      ...
      <section className="section section-alt">
        <div className="container-page">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Best EFTPOS for Landscapers by State</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {STATES.map(s => (
              <Link
                key={s.slug}
                to={`/states/${s.slug}/landscapers`}

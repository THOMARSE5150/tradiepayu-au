...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Builders in Australia (2026)', name: 'Best EFTPOS for Builders in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('builders'), width: 1200, height: 630 }, description: 'Progress payments, new estate sites, and subcontractor cash flow — the best payment setup for Australian building businesses.', url: `${SITE}/trades/builders`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for Builders in Australia', serviceType: 'EFTPOS Payment Processing for Builders', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/builders` },
]
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={tradeHeroUrl('builders')}
            alt={tradeHeroAlt('builders')}
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across progress payments, deposits, and high-value build invoices.
          </p>

...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Builders in Australia (2026)', name: 'Best EFTPOS for Builders in Australia (2026)', image: { '@type': 'ImageObject', url: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1200&h=630&fit=crop&crop=center&q=80', width: 1200, height: 630 }, description: 'Progress payments, new estate sites, and subcontractor cash flow — the best payment setup for Australian building businesses.', url: `${SITE}/trades/builders`, datePublished: '2026-01-15', dateModified: '2026-03-31', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

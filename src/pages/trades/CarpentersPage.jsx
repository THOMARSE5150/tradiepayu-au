...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Carpenters in Australia (2026)', description: 'New build sites with no WiFi, builder invoicing, and high-value custom joinery — the best EFTPOS and payment setup for Australian carpenters.', url: `${SITE}/trades/carpenters`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

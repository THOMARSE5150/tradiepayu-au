...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Plasterers in Australia (2026)', description: 'Builder sub-contracting, dusty environments, staged billing, and same-day material cash flow — the best EFTPOS and payment setup for Australian plasterers.', url: `${SITE}/trades/plasterers`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

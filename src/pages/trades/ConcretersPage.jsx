...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Concreters in Australia (2026)', name: 'Best EFTPOS for Concreters in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('concreters'), width: 1200, height: 630 }, description: 'Remote estate sites with no WiFi, large deposits, and materials cash flow — the best EFTPOS and payment setup for Australian concreting businesses.', url: `${SITE}/trades/concreters`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for Concreters in Australia', serviceType: 'EFTPOS Payment Processing for Concreters', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/concreters` },
]
...
export default function ConcretersPage() {
  ...
  return (
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across large pours, material deposits, and new estate site payments.
          </p>
      ...
      <section className="section section-alt">
        <div className="container-page">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Best EFTPOS for Concreters by State</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {STATES.map(s => (
              <Link
                key={s.slug}
                to={`/states/${s.slug}/concreters`}

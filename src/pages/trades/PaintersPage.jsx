...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Painters in Australia (2026)', name: 'Best EFTPOS for Painters in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('painters'), width: 1200, height: 630 }, description: 'Empty houses with no WiFi, deposit collection, and body corporate billing — the best EFTPOS and payment setup for Australian painting businesses.', url: `${SITE}/trades/painters`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={tradeHeroUrl('painters')}
            alt={tradeHeroAlt('painters')}
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across deposit collection, residential jobs, and body corporate billing.
          </p>

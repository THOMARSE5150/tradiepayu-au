...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Cleaners in Australia (2026)', name: 'Best EFTPOS for Cleaners in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('cleaners'), width: 1200, height: 630 }, description: 'High-frequency, lower-value jobs with recurring clients — the best EFTPOS setup to minimise fees and make regular clients frictionless.', url: `${SITE}/trades/cleaners`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for Cleaners in Australia', serviceType: 'EFTPOS Payment Processing for Cleaners', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/cleaners` },
]
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <img
            src={tradeHeroUrl('cleaners')}
            alt={tradeHeroAlt('cleaners')}
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across high-frequency cleaning jobs and recurring client accounts.
          </p>
      ...
      <section className="section section-alt">
        <div className="container-page">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Best EFTPOS for Cleaners by State</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {STATES.map(s => (
              <Link
                key={s.slug}
                to={`/states/${s.slug}/cleaners`}

...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Gas Fitters in Australia (2026)', description: 'Underground dead zones, emergency call-outs, and dual billing on gas connections — the best EFTPOS and payment setup for Australian gas fitters.', url: `${SITE}/trades/gas-fitters`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

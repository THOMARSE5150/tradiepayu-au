...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Tilers in Australia (2026)', description: 'Bathroom renos with no WiFi, materials deposits, and developer billing — the best EFTPOS and payment setup for Australian tiling businesses.', url: `${SITE}/trades/tilers`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

...
const faqs = [
  ...
  { q: 'How much does EFTPOS cost a tiling business per month?', a: 'At $8,000/month in card revenue, Zeller costs $112/month (1.4%) plus $15 SIM = $127. Square at the same volume is $128 (1.6%). For a tiler doing renovation work where tiles must be ordered before starting, same-day Zeller settlement is the critical feature — deposits clear overnight and you can order materials first thing next morning.' },
  { q: 'Is it hard to set up EFTPOS compared to a bank?', a: 'No — Zeller and Square approve accounts online in minutes with just your ABN. Bank merchant accounts require paperwork and often take days or weeks. Most tilers are set up and accepting payments the same day they register with Zeller.' },
  { q: 'Can tilers track multiple jobs and deposits across different clients?', a: 'Yes — Stripe invoicing assigns unique invoice numbers and tracks payment status per job. Zeller also tags each transaction with a reference note. For tilers managing 4–6 active jobs at different stages, Stripe gives a cleaner dashboard view of who has paid their deposit vs who still owes the balance.' },
]

import siteMeta from '../../data/site-meta.json'
const SITE = 'https://tradiepayau.directory'
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Tilers in Australia (2026)', name: 'Best EFTPOS for Tilers in Australia (2026)', image: { '@type': 'ImageObject', url: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=1200&h=630&fit=crop&crop=center&q=80', width: 1200, height: 630 }, description: 'Bathroom renos with no WiFi, materials deposits, and developer billing — the best EFTPOS and payment setup for Australian tiling businesses.', url: `${SITE}/trades/tilers`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for Tilers in Australia', serviceType: 'EFTPOS Payment Processing for Tilers', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/tilers` },
]
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=900&h=560&fit=crop&crop=center&q=80" alt="" fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />
      ...
      <section className="section section-alt">
        <div className="container-page">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Best EFTPOS for Tilers by State</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {STATES.map(s => (
              <Link
                key={s.slug}
                to={`/states/${s.slug}/tilers`}

...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Roofers in Australia (2026)', description: 'Large job values, insurance billing, and new estate sites with no WiFi — the best EFTPOS and payment setup for Australian roofing businesses.', url: `${SITE}/trades/roofers`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

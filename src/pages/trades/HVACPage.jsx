...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for HVAC Technicians in Australia (2026)', name: 'Best EFTPOS for HVAC Technicians in Australia (2026)', image: { '@type': 'ImageObject', url: tradeOgUrl('hvac'), width: 1200, height: 630 }, description: 'Commercial rooftop dead zones, after-hours emergencies, and split parts/labour billing — the best EFTPOS setup for Australian HVAC and refrigeration businesses.', url: `${SITE}/trades/hvac`, datePublished: '2026-01-15', dateModified: siteMeta.lastVerified, author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for HVAC Technicians in Australia', serviceType: 'EFTPOS Payment Processing for HVAC Technicians', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/hvac` },
]
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={tradeHeroUrl('hvac')} alt={tradeHeroAlt('hvac')} fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />
        ...
        <div className="container-page relative z-10">
          ...
          <p className="mt-4 text-sm text-white/65 max-w-lg">
            Check what EFTPOS fees actually cost you across after-hours call-outs, commercial HVAC jobs, and warranty work.
          </p>

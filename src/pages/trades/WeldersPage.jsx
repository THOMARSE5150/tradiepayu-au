...
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', name: 'Best EFTPOS for Welders in Australia (2026)', description: 'Commercial fabrication B2B billing, on-site structural work, steel stock deposits, and compliance invoice trails — the best EFTPOS and payment setup for Australian welders.', url: `${SITE}/trades/welders`, datePublished: '2026-01-15', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },

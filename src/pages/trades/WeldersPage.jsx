...
const faqs = [
  ...
  { q: 'How much does EFTPOS cost a welding business per month?', a: 'For on-site welding with $8,000/month in card revenue, Zeller costs $112/month (1.4%) plus $15 SIM = $127. For shop-based fabrication billing via Stripe invoicing, the cost is 1.7% + $0.10 per transaction on card payments — or 0.8% for bank transfers (recommended for high-value fabrication invoices where the transaction amount is significant).' },
  { q: 'Can welders accept bank transfer for large fabrication invoices?', a: 'Yes — Stripe invoicing supports bank transfer (BPAY or direct debit) as well as card. For fabrication invoices over $5,000, bank transfer at 0.8% (Stripe) significantly reduces the fee compared to card at 1.7% + $0.10. Simply offer both payment options on the invoice and let the client choose.' },
  { q: 'Is it hard to set up EFTPOS for a welding business?', a: 'No — Zeller and Stripe both approve accounts online with just your ABN. For a fabrication business, Stripe takes slightly longer (identity verification required) but is worth it for the invoicing and recurring billing features. Zeller is faster — same-day account activation for on-site terminal payments.' },
]

const SITE = 'https://tradiepayau.directory'
const jsonLd = [
  { '@context': 'https://schema.org', '@type': 'Article', headline: 'Best EFTPOS for Welders in Australia (2026)', name: 'Best EFTPOS for Welders in Australia (2026)', image: { '@type': 'ImageObject', url: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=1200&h=630&fit=crop&crop=center&q=80', width: 1200, height: 630 }, description: 'Commercial fabrication B2B billing, on-site structural work, steel stock deposits, and compliance invoice trails — the best EFTPOS and payment setup for Australian welders.', url: `${SITE}/trades/welders`, datePublished: '2026-01-15', dateModified: '2026-03-31', author: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, publisher: { '@type': 'Organization', name: 'TradiePay AU', url: SITE } },
  { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: `${SITE}/` }, { '@type': 'ListItem', position: 2, name: 'By Trade', item: `${SITE}/trades` }, { '@type': 'ListItem', position: 3, name: 'Best EFTPOS for Welders', item: `${SITE}/trades/welders` }] },
  { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: faqs.map(f => ({ '@type': 'Question', name: f.q, acceptedAnswer: { '@type': 'Answer', text: f.a } })) },
  { '@context': 'https://schema.org', '@type': 'Service', name: 'Best EFTPOS for Welders in Australia', serviceType: 'EFTPOS Payment Processing for Welders', areaServed: { '@type': 'Country', name: 'Australia' }, provider: { '@type': 'Organization', name: 'TradiePay AU', url: SITE }, url: `${SITE}/trades/welders` },
]
...
export default function WeldersPage() {
  return (
    <>
      ...
      <section className="section section-alt">
        <div className="container-page">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Best EFTPOS for Welders by State</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {STATES.map(s => (
              <Link
                key={s.slug}
                to={`/states/${s.slug}/welders`}

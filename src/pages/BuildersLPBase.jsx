...
const PAIN_POINTS = [
  {
    emoji: '🏗️',
    title: 'Active construction sites — no building WiFi yet',
    body: 'The structure isn\'t complete, the NBN isn\'t connected, and the site has no internet. You need to take a progress payment from the client — but your terminal won\'t connect. The right terminal runs on its own SIM.',
  },
  {
    emoji: '📍',
    title: 'Rural and remote builds — poor signal, long distances',
    body: 'Acreage homes, rural subdivisions, and country extensions often have patchy mobile coverage. Zeller\'s built-in Optus SIM handles most sites. Square\'s offline mode is the backup for genuine zero-signal locations.',
  },
  {
    emoji: '💸',
    title: 'Progress payments and variations need fast sign-off',
    body: 'Milestone payments, variation approvals, and stage sign-offs need to happen on-site when the client is there. Delays cost you float. A reliable terminal means payment happens the moment the work is approved.',
  },
  {
    emoji: '📋',
    title: 'Deposits to lock in materials before you break ground',
    body: 'Timber frames, structural steel, and concrete orders need a deposit at contract execution before you mobilise. Zeller payment link for the deposit. Terminal for progress payments on-site.',
  },
]

const COMPARISON = [
  { provider: 'Zeller Terminal 1 + SIM', rate: '1.4%', cost: '$99 + $15/mo', note: 'Primary — site payments, rural builds',    recommended: true },
  { provider: 'Square Terminal',         rate: '1.6%', cost: '$329 once',     note: 'Backup — remote areas, offline mode',     recommended: false },
  { provider: 'Zeller Payment Link',     rate: '1.4%', cost: 'Free',          note: 'Deposits and contract sign-off billing',  recommended: false },
]

const STEPS = [
  { n: '1', title: 'Sign up with your ABN',          body: 'Online approval in minutes — just your ABN. No bank branch visit, no paperwork.' },
  { n: '2', title: 'Hardware ships fast',             body: 'Zeller Terminal ships within Australia. Most builders receive it in 1–3 business days.' },
...
export default function BuildersLPBase({ config }) {
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={tradeHeroUrl('builders')} alt={tradeHeroAlt('builders')} fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />
      ...
      <section className="section-alt py-10 sm:py-14">
        <div className="container-page">
          <div className="mb-8 pb-8 border-b border-slate-200">
            <h2 className="text-xl font-bold text-brand-dark mb-2">Best EFTPOS for builders in Australia (2026)</h2>
            <p className="text-sm text-slate-600 leading-relaxed max-w-2xl">For Australian builders, choosing the right EFTPOS matters — especially for active construction sites, rural builds, and progress payment sign-offs. This guide compares Zeller, Square, Stripe, and other options based on real building use cases, including rates, SIM connectivity, and same-day settlement.</p>
      ...
      <section className="section bg-white">
        <div className="container-page">
          <div className="max-w-2xl">
            <p className="text-[11px] font-bold uppercase tracking-widest text-brand-blue mb-2">Top pick for builders in Australia</p>
            <h2 className="text-2xl font-bold text-brand-dark mb-1">Zeller Terminal 1 + SIM Plan</h2>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">The go-to EFTPOS setup for Australian builders on active construction sites, rural builds, and residential projects. Runs on the Optus mobile network — no site WiFi needed.</p>
      ...
      <section className="section section-alt">
        <div className="container-page">
          ...
          <p className="text-sm text-slate-500 mb-5">The three setups used by Australian builders — when and why.</p>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 max-w-lg">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: 'Does it work on active construction sites?',      a: 'The Zeller SIM handles most construction sites without building WiFi. Add Square Terminal as a backup for remote areas with genuine zero-signal conditions.' },
                { q: 'What about rural or regional builds?',            a: 'Zeller runs on the Optus mobile network, which covers most of regional Australia. For very remote sites, Square\'s offline mode accepts cards with no connectivity.' },
                { q: 'Can I take a deposit at contract signing?',       a: 'Yes — send a Zeller payment link. The client pays remotely; you get the deposit cleared before mobilising.' },
              ].map(({ q, a }) => (
                <div key={q}>
      ...
      <section className="section">
        <div className="container-page">
          <div className="bg-brand-dark rounded-3xl px-6 py-10 sm:px-10 sm:py-12 text-center">
            <p className="text-amber-400 text-xs font-bold uppercase tracking-widest mb-3">For Australian builders</p>

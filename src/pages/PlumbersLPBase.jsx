...
const PAIN_POINTS = [
  {
    emoji: '🚨',
    title: 'Emergency callouts — burst pipes, any hour, no signal',
    body: 'Burst pipe at 2am. Blocked drain on a Sunday. You show up, fix it, then can\'t take payment because the building has no WiFi and the customer\'s phone has no signal. The right terminal runs on its own SIM.',
  },
  {
    emoji: '💧',
    title: 'Plant rooms, meter boxes, and underground dead zones',
    body: 'Basement plant rooms, underground water mains, meter boxes in concrete walls — mobile signal disappears. Zeller\'s built-in Optus SIM handles most commercial sites. Square\'s offline mode is the backup for genuine zero-signal locations.',
  },
  {
    emoji: '💬',
    title: '"I\'ll bank transfer you" — and then they don\'t',
    body: 'Residential clients who promise a bank transfer at job completion often delay for days or disappear entirely. Taking payment on-site at job completion eliminates invoice chasing and keeps your cash flow clean.',
  },
  {
    emoji: '📋',
    title: 'Deposits before you order fixtures or hot water systems',
    body: 'Hot water system replacements, bathroom renovations, and major installs need a deposit at quote acceptance to cover the materials order. Zeller payment link for the deposit. Terminal for the balance on-site at completion.',
  },
]
...
const STEPS = [
  ...
  { n: '2', title: 'Hardware ships fast',             body: 'Zeller Terminal ships within Australia. Most plumbers receive it in 1–3 business days.' },
...
export default function PlumbersLPBase({ config }) {
    ...
    <>
      ...
      <header className="hero relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src={tradeHeroUrl('plumbers')} alt={tradeHeroAlt('plumbers')} fetchPriority="high" className="w-full h-full object-cover" onError={e => { e.currentTarget.style.opacity = '0' }} />
      ...
      <section className="section-alt py-10 sm:py-14">
        <div className="container-page">
          <div className="mb-8 pb-8 border-b border-slate-200">
            <h2 className="text-xl font-bold text-brand-dark mb-2">Best EFTPOS for plumbers in Australia (2026)</h2>
            <p className="text-sm text-slate-600 leading-relaxed max-w-2xl">For Australian plumbers, choosing the right EFTPOS matters — especially for emergency callouts, plant rooms, and rural properties. This guide compares Zeller, Square, Stripe, and other options based on real plumbing use cases, including rates, SIM connectivity, and same-day settlement.</p>
      ...
      <section className="section bg-white">
        <div className="container-page">
          <div className="max-w-2xl">
            <p className="text-[11px] font-bold uppercase tracking-widest text-brand-blue mb-2">Top pick for plumbers in Australia</p>
            <h2 className="text-2xl font-bold text-brand-dark mb-1">Zeller Terminal 1 + SIM Plan</h2>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">The go-to EFTPOS setup for Australian plumbers on emergency callouts, commercial installs, and residential repairs. Runs on the Optus mobile network — no customer WiFi needed.</p>
      ...
      <section className="section section-alt">
        <div className="container-page">
          ...
          <p className="text-sm text-slate-500 mb-5">The three setups used by Australian plumbers — when and why.</p>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 max-w-lg">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: 'Does it work in plant rooms and basements?', a: 'The Zeller SIM handles most commercial environments. Add Square Terminal as a backup for underground or genuine dead-zone locations — its offline mode accepts cards with no connectivity.' },
                ...
                { q: 'Can I take a deposit before I order parts?', a: 'Yes — send a Zeller payment link at quote acceptance. The customer pays remotely; you get the deposit cleared before ordering materials.' },
              ].map(({ q, a }) => (
                <div key={q}>
      ...
      <section className="section">
        <div className="container-page">
          <div className="bg-brand-dark rounded-3xl px-6 py-10 sm:px-10 sm:py-12 text-center">
            <p className="text-amber-400 text-xs font-bold uppercase tracking-widest mb-3">For Australian plumbers</p>
